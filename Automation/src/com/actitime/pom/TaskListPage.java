...
public class TaskListPage {
    ...
    private WebElement createCustomerTx;
	
	@FindBy(xpath="//textarea[@placeholder='Add Project Description']")
	private WebElement descriptionTx;
	...
	public WebElement getCreateCustomerTx() {
		return createCustomerTx;
	}

	public WebElement getDescriptionTx() {
